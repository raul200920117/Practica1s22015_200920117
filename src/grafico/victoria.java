...
public class victoria extends javax.swing.JFrame {
    ...
    public void fondo(){
        String path = "/imagenes/MARIO+019.gif";
    ...
    void sonido() throws LineUnavailableException, IOException, UnsupportedAudioFileException{
        BufferedInputStream bis = new BufferedInputStream(getClass().getResourceAsStream("/musica/victoria.mid"));
    ...
    public void punteo(int punteo,  int vidas, int tiempo){
        fondo();
        jLabel4.setText("" + punteo);
        jLabel6.setText("" + vidas);
        jLabel12.setText("" + tiempo);
        int res = punteo + (vidas * 100) + (tiempo * 10);
        jLabel8.setText("" + res);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Felicidades Juego ");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 270, 50));
        ...
        jLabel5.setText("Vidas restantes:");
        ...
        jLabel9.setText("X100");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, -1, -1));
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 90, 80));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, -1, -1));

        jLabel13.setFont(new java.awt.Font("Tempus Sans ITC", 0, 14)); // NOI18N
        jLabel13.setText("X10");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, -1, -1));
